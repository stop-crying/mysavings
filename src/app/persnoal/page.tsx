...
export default function Personal({ params }: persnoalProps) {
  return (
    <div className=" w-full mt-3 flex items-center justify-center flex-col gap-8">
      <div className="w-full  bg-[url(https://wallpapercave.com/wp/wp7130410.jpg)] bg-contain rounded-3xl drop-shadow-xl shadow-xl flex items-center justify-between gap-6 px-5 py-8 hover:-translate-y-1 duration-300">
        <span className="flex items-center justify-center gap-5">
          ...
          <span className="flex flex-col justify-start items-start gap-3">
            <b className="text-base font-light text-white tracking-wide">
              {params.toDo}
            </b>
        ...
        <span className="flex items-center justify-center gap-4">
          <span className="flex flex-col justify-start items-start gap-3">
            <p className="text-[#7b7d8c] font-extralight text-sm tracking-wide ">
              Goal
            </p>
